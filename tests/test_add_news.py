...
def test_add_news_item(tmp_path):
    ...
    args1 = SimpleNamespace(
        add=True, change=False, deprecate=False, remove=False,
        fix=False, security=False, message="Add first news."
    )
    news_item(args1)
...
"""
    ...
    args2 = SimpleNamespace(
        add=True, change=False, deprecate=False, remove=False,
        fix=False, security=False, message="Add second news."
    )
    news_item(args2)
...
def test_no_news_item(tmp_path):
    ...
    args = SimpleNamespace(
        add=False, change=False, deprecate=False, remove=False,
        fix=False, security=False, message="Fix small typo."
    )
    news_item(args)
